...
using SignalRCoreChat.Mvc.Data;
...
namespace SignalRCoreChat.Mvc.Hubs
{
            ...
            try
            {
                ...
                await Clients.All.SendAsync("Broadcast",
                    new
                    {
                        ...
                        messageDtTm = m.MessageDtTm.ToString("hh:mm tt MMM dd", CultureInfo.InvariantCulture)
                    });
            }
            catch (Exception ex)
            {
        ...
        public override async Task OnConnectedAsync()
        {
            await Clients.All.SendAsync("UserConnected",
                new {
                    ...
                    messageDtTm = DateTime.Now.ToString("hh:mm tt MMM dd", CultureInfo.InvariantCulture),
                });
        }
